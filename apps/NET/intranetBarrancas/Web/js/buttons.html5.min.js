...
"Exported data") : a
    ...
    s.ext.buttons.copyHtml5 = { className: "buttons-copy buttons-html5", text: function (a) { return a.i18n("buttons.copy", "Copy") }, action: function (a, b, d, c) {
...
"Copy to clipboard"), b.i18n("buttons.copySuccess", { 1: "Copied one row to clipboard", _: "Copied %d rows to clipboard" }, a.rows), 2E3); return
    ...
    }; s.ext.buttons.csvHtml5 = { className: "buttons-csv buttons-html5", available: function () { return j.FileReader !== m && j.Blob }, text: function (a) { return a.i18n("buttons.csv", "CSV") }, action: function (a, b, d, c) {
...
(a = c.customize(a, c)); if (b !== false) { b || (b = i.characterSet || i.charset); b && (b = ";charset=" + b) } else b = ""; p(new Blob([a], { type: "text/csv" + b }), x(c))
    ...
    }; s.ext.buttons.excelHtml5 = { className: "buttons-excel buttons-html5", available: function () { return j.FileReader !== m && q !== m && !M() && y }, text: function (a) { return a.i18n("buttons.excel", "Excel") }, action: function (a, b, d, c) {
...
26) - 1
    ...
    }; s.ext.buttons.pdfHtml5 = { className: "buttons-pdf buttons-html5", available: function () { return j.FileReader !== m && r }, text: function (a) { return a.i18n("buttons.pdf", "PDF") }, action: function (a, b, d, c) {
